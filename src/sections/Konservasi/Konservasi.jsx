...
const Konservasi = () => {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-1 md:p-20 p-10 text-color-2 font-poppins">
        ...
        <div className="flex md:flex-row flex-col justify-center">
          <div className="relative">
            <div className="sticky top-96 min-h-screen overflow-hidden flex space-x-4 w-full max-md:hidden">
              <div className="grid flex-shrink-0 grid-cols-1 gap-2">
                <motion.div
                  ref={ref2}
                  className="h-[367px] w-44 overflow-hidden"
              ...
              <div className="grid flex-shrink-0 grid-cols-1 gap-4">
                <motion.div
                  ref={ref5}
                  className="h-[471px] w-72 overflow-hidden"
                  variants={itemVariants}
                  initial="hidden"
                ...
                <motion.div
                  ref={ref7}
                  className="h-[189px] w-72 overflow-hidden"
                  variants={itemVariants}
                  initial="hidden"
          ...
          <div className="w-full lg:w-3/6 md:ps-5 ps-0 max-md:mt-20">
            <TextContent />
          </div>
        </div>
      </div>
