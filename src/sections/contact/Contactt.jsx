        ...
        <div className="flex flex-col md:flex-row  justify-center gap-4">
          <div>
            <img
              ...
              className="md:w-[50rem]  w-[18rem] rounded-3xl md:mx-0 mx-auto bg-[#82DF85] border-[3px] border-[#1D4735]"
            />
          </div>
          <div className="bg-color-1  rounded-[1.62rem] border-[3px] p-3 xl:p-8 border-[#1D4735]">
            <p className="font-bold font-poppins text-[11px] md:text-[15px] text-color-3  ">
              Jamaro David Saragih
            </p>
            <p className="font-bold font-poppins text-[10px] text-color-3 md:text-[13px]   ">
              (Team Leader)
            </p>
            <p className="font-semibold font-poppins text-[8px] md:text-[10px] xl:text-[14px] text-color-3 ">
